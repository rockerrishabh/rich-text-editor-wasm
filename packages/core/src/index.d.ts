...
export { getWasmMemoryStats, getActiveInstanceCount, } from "./utils/wasmManager";
export { debounce, throttle, RenderBatcher, calculateVisibleRange, DEFAULT_VIEWPORT_CONFIG, } from "./utils/performance";
export type { ViewportConfig } from "./utils/performance";
export { sanitizeHTML, sanitizeURL, sanitizeStyle, validateColor, escapeHTML, } from "./utils/security";
export type { Selection, SearchMatch, ClipboardData, CompositionRange, DirtyRegion, MemoryStats, SimpleFormatType, ValueFormatType, FormatType, Format, BlockType, EditorEventType, EditorEventCallback, EditorOptions, ToolbarConfig, ToolbarButtonType, ToolbarButton, ToolbarButtonGroup, CustomToolbarButton, StatusBarConfig, StatusBarItemType, StatusBarItem, LogLevel, LoggingConfig, ErrorCode, } from "./types";
